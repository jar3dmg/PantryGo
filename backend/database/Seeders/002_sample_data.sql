...
SELECT
    ...
    src.description
FROM (
    SELECT 'verduras' AS category_slug, 'cup' AS unit_code, 'Espinaca' AS name, 'espinaca' AS slug, 'Hoja verde de sabor suave.' AS description
    UNION ALL SELECT 'verduras', 'piece', 'Cebolla', 'cebolla', 'Base aromatica para guisos.'
    UNION ALL SELECT 'verduras', 'piece', 'Ajo', 'ajo', 'Condimento fresco e intenso.'
    UNION ALL SELECT 'verduras', 'gram', 'Champinon', 'champinon', 'Hongo de sabor delicado.'
    UNION ALL SELECT 'verduras', 'piece', 'Tomate', 'tomate', 'Tomate rojo para salsas y ensaladas.'
    UNION ALL SELECT 'verduras', 'gram', 'Calabaza', 'calabaza', 'Calabaza tierna para cremas y guarniciones.'
    UNION ALL SELECT 'verduras', 'piece', 'Pimiento rojo', 'pimiento-rojo', 'Pimiento dulce para saltear.'
    UNION ALL SELECT 'verduras', 'piece', 'Pepino', 'pepino', 'Verdura fresca para ensaladas y snacks.'
    UNION ALL SELECT 'verduras', 'cup', 'Lechuga', 'lechuga', 'Hoja fresca para ensaladas.'
    UNION ALL SELECT 'verduras', 'gram', 'Flor de calabaza', 'flor-calabaza', 'Flor suave para quesadillas.'
    UNION ALL SELECT 'verduras', 'piece', 'Papa', 'papa', 'Tuberculo para guisos y guarniciones.'
    UNION ALL SELECT 'verduras', 'piece', 'Zanahoria', 'zanahoria', 'Verdura dulce y crujiente.'
    UNION ALL SELECT 'verduras', 'piece', 'Camote', 'camote', 'Tuberculo dulce para hornear.'
    UNION ALL SELECT 'frutas', 'piece', 'Platano', 'platano', 'Fruta dulce ideal para desayunos.'
    UNION ALL SELECT 'frutas', 'piece', 'Fresa', 'fresa', 'Fruta fresca de sabor dulce.'
    UNION ALL SELECT 'frutas', 'piece', 'Mango', 'mango', 'Fruta tropical de pulpa suave.'
    UNION ALL SELECT 'frutas', 'cup', 'Pina', 'pina', 'Fruta tropical jugosa.'
    UNION ALL SELECT 'frutas', 'piece', 'Limon', 'limon', 'Citricos para bebidas y aderezos.'
    UNION ALL SELECT 'frutas', 'piece', 'Manzana', 'manzana', 'Fruta crujiente para postres.'
    UNION ALL SELECT 'frutas', 'piece', 'Naranja', 'naranja', 'Citricos dulces para jugos.'
    UNION ALL SELECT 'frutas', 'piece', 'Durazno', 'durazno', 'Fruta suave para bebidas y postres.'
    UNION ALL SELECT 'frutas', 'piece', 'Aguacate', 'aguacate', 'Fruta cremosa para tostadas y ensaladas.'
    UNION ALL SELECT 'frutas', 'cup', 'Frutos secos', 'frutos-secos', 'Mezcla de nueces y semillas.'
    UNION ALL SELECT 'carnes', 'gram', 'Pollo', 'pollo', 'Proteina magra de uso comun.'
    UNION ALL SELECT 'carnes', 'gram', 'Jamon', 'jamon', 'Fiambre para desayunos y snacks.'
    UNION ALL SELECT 'carnes', 'gram', 'Carne de res', 'carne-res', 'Carne para guisos y fajitas.'
    UNION ALL SELECT 'carnes', 'gram', 'Pescado blanco', 'pescado-blanco', 'Filete suave para sarten.'
    UNION ALL SELECT 'carnes', 'gram', 'Atun', 'atun', 'Proteina lista para mezclar.'
    UNION ALL SELECT 'lacteos', 'gram', 'Queso manchego', 'queso-manchego', 'Queso que funde bien.'
    UNION ALL SELECT 'lacteos', 'cup', 'Yogurt natural', 'yogurt-natural', 'Yogurt sin saborizantes.'
    UNION ALL SELECT 'lacteos', 'cup', 'Crema', 'crema', 'Crema para salsas y postres.'
    UNION ALL SELECT 'lacteos', 'milliliter', 'Leche', 'leche', 'Leche entera para preparaciones.'
    UNION ALL SELECT 'lacteos', 'gram', 'Parmesano', 'parmesano', 'Queso duro para pastas.'
    UNION ALL SELECT 'lacteos', 'gram', 'Mantequilla', 'mantequilla', 'Grasa lactea para saltear y hornear.'
    UNION ALL SELECT 'lacteos', 'gram', 'Queso crema', 'queso-crema', 'Queso untuoso para rellenos.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Avena', 'avena', 'Cereal integral versatil.'
    UNION ALL SELECT 'cereales-y-granos', 'piece', 'Pan integral', 'pan-integral', 'Pan rebanado de grano integral.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Arroz', 'arroz', 'Cereal base para recetas saladas y dulces.'
    UNION ALL SELECT 'cereales-y-granos', 'gram', 'Pasta', 'pasta', 'Pasta seca para platos rapidos.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Quinoa', 'quinoa', 'Semilla cocida rica en proteina.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Granola', 'granola', 'Mezcla tostada para desayunos.'
    UNION ALL SELECT 'cereales-y-granos', 'piece', 'Tortilla de maiz', 'tortilla-maiz', 'Tortilla tradicional para tacos y quesadillas.'
    UNION ALL SELECT 'cereales-y-granos', 'piece', 'Tortilla de harina', 'tortilla-harina', 'Tortilla suave para wraps y fajitas.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Harina de trigo', 'harina-trigo', 'Base para panes y postres.'
    UNION ALL SELECT 'cereales-y-granos', 'piece', 'Galleta Maria', 'galleta-maria', 'Galleta dulce para bases de postre.'
    UNION ALL SELECT 'cereales-y-granos', 'cup', 'Maiz palomero', 'maiz-palomero', 'Grano seco para hacer palomitas.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Canela', 'canela', 'Especia aromatica para postres y bebidas.'
    UNION ALL SELECT 'especias-y-condimentos', 'cup', 'Salsa verde', 'salsa-verde', 'Salsa de chile verde y tomate.'
    UNION ALL SELECT 'especias-y-condimentos', 'tablespoon', 'Chipotle', 'chipotle', 'Chile adobado de sabor intenso.'
    UNION ALL SELECT 'especias-y-condimentos', 'tablespoon', 'Azucar', 'azucar', 'Endulzante comun.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Vainilla', 'vainilla', 'Extracto aromatico para postres.'
    UNION ALL SELECT 'especias-y-condimentos', 'gram', 'Chocolate', 'chocolate', 'Chocolate para bebidas y postres.'
    UNION ALL SELECT 'especias-y-condimentos', 'tablespoon', 'Miel', 'miel', 'Endulzante natural.'
    UNION ALL SELECT 'especias-y-condimentos', 'tablespoon', 'Aceite de oliva', 'aceite-oliva', 'Grasa vegetal para cocinar.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Chile en polvo', 'chile-polvo', 'Condimento para snacks y frutas.'
    UNION ALL SELECT 'especias-y-condimentos', 'cup', 'Flor de jamaica', 'jamaica', 'Base para agua fresca.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Sal', 'sal', 'Sazonador basico.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Pimienta', 'pimienta', 'Especia para sazonar.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Polvo para hornear', 'polvo-hornear', 'Leudante para hotcakes y postres.'
    UNION ALL SELECT 'especias-y-condimentos', 'teaspoon', 'Cafe soluble', 'cafe-soluble', 'Cafe instantaneo para bebidas.'
    UNION ALL SELECT 'especias-y-condimentos', 'tablespoon', 'Grenetina', 'grenetina', 'Gelificante para postres.'
    UNION ALL SELECT 'leguminosas', 'cup', 'Lenteja', 'lenteja', 'Leguminosa para sopas y guisos.'
    UNION ALL SELECT 'leguminosas', 'cup', 'Garbanzo', 'garbanzo', 'Leguminosa para ensaladas y hummus.'
    UNION ALL SELECT 'leguminosas', 'cup', 'Frijol', 'frijol', 'Leguminosa para rellenos y molletes.'
    UNION ALL SELECT 'lacteos', 'piece', 'Huevo', 'huevo', 'Ingrediente base para desayunos y postres.'
) AS src
