...
CREATE TABLE ingredients (
    ...
    preferred_measurement_unit_id INT UNSIGNED NULL,
    name VARCHAR(150) NOT NULL,
    slug VARCHAR(180) NOT NULL UNIQUE,
    description TEXT NULL,
    seasonal_month_start TINYINT UNSIGNED NULL,
    seasonal_month_end TINYINT UNSIGNED NULL,
    ...
    CONSTRAINT fk_ingredients_measurement_unit
        FOREIGN KEY (preferred_measurement_unit_id) REFERENCES catalog_measurement_units (measurement_unit_id)
);
...
CREATE TABLE recipe_ingredients (
    ...
    CONSTRAINT fk_recipe_ingredients_ingredient
        FOREIGN KEY (ingredient_id) REFERENCES ingredients (ingredient_id),
    CONSTRAINT fk_recipe_ingredients_measurement_unit
